                    ...
                    <div class="col-sm-12 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblCardNumber" runat="server"
                                Text="Card Number" ForeColor="Gray"></asp:Label>
                            <asp:TextBox ID="txtCardNumber" runat="server"
                                CssClass="form-control" MaxLength="19"
                                placeholder="Enter Card Number"></asp:TextBox>
                        </div>

                        <div class="form-group">
                            <asp:Label ID="lblName" runat="server"
                                Text="Name on Card" ForeColor="Gray"></asp:Label>
                            <asp:TextBox ID="txtName" runat="server"
                                CssClass="form-control"
                                placeholder="Enter Name on Card"></asp:TextBox>
                        </div>

                        <div class="form-group">
                            <asp:Label ID="lblExpiryDate" runat="server"
                                Text="Expiry Date (MM/YY)" ForeColor="Gray"></asp:Label>
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblCVV" runat="server"
                                Text="CVV" ForeColor="Gray"></asp:Label>
                            <asp:TextBox ID="txtCVV" runat="server"
                                CssClass="form-control" MaxLength="4"
                                TextMode="Password"
                                placeholder="Enter CVV"></asp:TextBox>
                        </div>
