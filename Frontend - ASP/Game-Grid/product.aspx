                ...
                <div class="dis-none panel-filter w-full p-t-10">
                    <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                        ...
                        <div class="filter-col1 p-r-15 p-b-27">
                            ...
                            <ul>
                                <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04 filter-link-active">Default</a></li>
                        ...
                        <div class="filter-col2 p-r-15 p-b-27">
                            ...
                            <ul>
                                ...
                                <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">R0.00 - R499.99</a></li>
                                <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">R500.00 - R1,999.99</a></li>
                                <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">R2,000.00 - R3,999.99</a></li>
                                <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">R4,000.00 +</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="filter-col3 p-r-15 p-b-27">
                            ...
                            <ul>
                                ...
                                <li class="p-b-6"><span class="fs-15 lh-12 m-r-6" style="color: #4272d7;"><i class="zmdi zmdi-circle"></i></span><a href="#" class="filter-link stext-106 trans-04">Blue</a></li>
                        ...
                        <div class="filter-col4 p-b-27">
                            ...
                            <div class="flex-w p-t-4 m-r--5">
                                <a href="#" class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5">Monitors</a>
                                <a href="#" class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5">Gaming</a>
                                <a href="#" class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5">Audio</a>
                                <a href="#" class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5">Cable &amp; Adapters</a>
                                <a href="#" class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5">PC Components</a>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35">
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    ...
                                    <!-- Quick View — data attributes feed the modal -->
                                    <a href="#"
                                ...
                                <div class="block2-txt flex-w flex-t p-t-14">
                                    <div class="block2-txt-child1 flex-col-l">
                                        ...
                                        <span class="stext-105 cl3">R <%# Eval("price", "{0:N2}") %></span>
                                    </div>

                                    <div class="block2-txt-child2 flex-r p-t-3">
                                        <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                                            <img class="icon-heart1 dis-block trans-04" src="/images/icons/icon-heart-01.png" alt="Wishlist">
                                            <img class="icon-heart2 dis-block trans-04 ab-t-l" src="/images/icons/icon-heart-02.png" alt="Wishlist">
                                        </a>
                                    </div>
                                </div>
                            </div>
